...
| D14 | Datos: re-traducción fiel (115) + catálogo completo con badge EN + patrones + descansos (A1–A4) | ⬜ | — |
...
### Orden en la cola
Después de la cola actual (36 → 37 → 35 → 38 → 39): **40 → 41 → 42**. Uno por vez; al cerrar
cada uno se verifica repo vs kit.
