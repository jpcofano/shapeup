...
>
> **Lotes 1 y 2 (14) — ya curados y CON IDs reales arriba.** Vienen de búsqueda web; **el owner
...
>
> **Para los lotes 3-N**, completá los EJ-8xxx que falten (20 restantes), priorizando los que más
...
>
> Pendientes (lotes próximos, 20): EJ-8003 dominadas asistidas, 8005 press pecho banda, 8009
> dominadas/chin-up, 8011 remo invertido, 8017 bird dog, 8018 pallof, 8020 búlgara, 8021 face
> pull, 8022 aperturas banda, 8023 gato-camello, 8024 world's greatest, 8025 círculos cadera,
> 8026 apertura torácica, 8027 estiram. isquios, 8028 curl nórdico, 8029 copenhague, 8030
> caminata lateral, 8031 salto con aterrizaje, 8032 RDL a una pierna, 8034 patada de glúteo.
>
> ---
>
> **Verificación:**
...
> - Re-seed + regenerar catálogo: los 14 de los lotes 1-2 quedan con `videoYoutubeId`.
> - En navegador real: la Demo de esos 14 reproduce el video de YouTube al tap, sin badge de
...
>   archivo `videos-curados.ts`, lotes 1-2 = 14, fix iOS de paso). Anotá el avance: `curados 14/34`.
>
> **Un commit** (cableado + lotes 1-2), mensaje tipo:
> `feat(video): demo YouTube curada — cableado + lotes 1-2 (14/34 rutinas)`
> Push. **Pará y esperá mi revisión — no encadenes el lote 3 sin que lo pida.**
